# Support for Output Descriptors in CnBCoin Core

Since CnBCoin Core v0.17, there is support for Output Descriptors. This is a
...
on CnBCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing CnBCoin Core wallets, a convenience function `combo` is
