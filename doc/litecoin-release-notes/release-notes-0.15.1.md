CnBCoin Core version *0.15.1* is now available from:

  <https://download.cnbcoin.org/cnbcoin-0.15.1/>
...
A number of changes to the way CnBCoin Core deals with peer connections and invalid blocks
