...
"""Verify that starting cnbcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cnbcoin with -h for help text")
        ...
        self.log.info("Start cnbcoin with -version for version information")
        ...
        self.log.info("Start cnbcoind with -fakearg to make sure it does not start")
