...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.cnbcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.cnbcointools.com");
        vSeeds.emplace_back("dnsseed.cnbcoinpool.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xA2, 0x8f, 0xB2, 0x2E};
        base58Prefixes[EXT_SECRET_KEY] = {0xA2, 0x8f, 0xfe, 0xE4};
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.cnbcointools.com");
        vSeeds.emplace_back("seed-b.cnbcoin.loshan.co.uk");
