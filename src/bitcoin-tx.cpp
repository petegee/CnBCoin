...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cnbcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cnbcoin-tx [options] <hex-tx> [commands]  Update hex-encoded cnbcoin transaction\n" +
            "or:     cnbcoin-tx [options] -create [commands]   Create hex-encoded cnbcoin transaction\n" +
            "\n";
