...
const char * const BITCOIN_CONF_FILENAME = "cnbcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Cnbcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Cnbcoin";
#else
    // Unix
    return pathRet / ".cnbcoin";
#endif
#endif
}
